...
namespace Lesson_26___Вывод_массива.Перебор_массива.Массивы_и_циклы
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //TASK №1 - заполнить массив с клавиатуры
            ...
            Console.ReadLine();
            //TASK №2 - вывести массив в обратном порядке
            ...
            Console.ReadLine();
            //TASK №3 - найти сумму четных элементов
            ...
            Console.ReadLine();
            //TASK №4 - найти наименьшее число в массиве
